...
public class WarmokSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case WarmokPackage.WARMOK_GAME: {
				WarmokGame warmokGame = (WarmokGame)theEObject;
				T result = caseWarmokGame(warmokGame);
				if (result == null) result = caseGame(warmokGame);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WarmokPackage.ROUND: {
				Round round = (Round)theEObject;
				T result = caseRound(round);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WarmokPackage.ORDERS: {
				Orders orders = (Orders)theEObject;
				T result = caseOrders(orders);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WarmokPackage.ORDER: {
				Order order = (Order)theEObject;
				T result = caseOrder(order);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WarmokPackage.BUY: {
				Buy buy = (Buy)theEObject;
				T result = caseBuy(buy);
				if (result == null) result = caseOrder(buy);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WarmokPackage.MOVE: {
				Move move = (Move)theEObject;
				T result = caseMove(move);
				if (result == null) result = caseOrder(move);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WarmokPackage.WORLD: {
				World world = (World)theEObject;
				T result = caseWorld(world);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WarmokPackage.NATION: {
				Nation nation = (Nation)theEObject;
				T result = caseNation(nation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WarmokPackage.TERRITORY: {
				Territory territory = (Territory)theEObject;
				T result = caseTerritory(territory);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WarmokPackage.UNIT_TYPE: {
				UnitType unitType = (UnitType)theEObject;
				T result = caseUnitType(unitType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WarmokPackage.UNIT: {
				Unit unit = (Unit)theEObject;
				T result = caseUnit(unit);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WarmokPackage.NATION_TYPE: {
				NationType nationType = (NationType)theEObject;
				T result = caseNationType(nationType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WarmokPackage.GEO_POINT: {
	 ...
	 * @generated
	 */
	public T caseWarmokGame(WarmokGame object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Nation Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Nation Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNationType(NationType object) {
		return null;
	}
